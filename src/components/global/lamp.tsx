    ...
    return (
        <LampContainer>
            <motion.h1
                ...
                className="mt-[-16rem] bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-5xl font-medium tracking-tight text-transparent md:text-8xl"
            >
                Pricing
            </motion.h1>
        </LampContainer>
...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex h-screen flex-col items-center justify-center overflow-hidden bg-neutral-950 w-full rounded-md z-0",
                className,
            )}
        >
